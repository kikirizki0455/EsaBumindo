...
export default function Login() {
  ...
  return (
    <AuthLayout>
      <div className="min-h-screen w-full flex flex-col lg:grid lg:grid-cols-5 relative overflow-hidden bg-linear-to-br from-gray-50 to-gray-100">
        ...
        <div className="relative lg:col-span-2 flex flex-col items-center justify-center p-8 lg:p-12 text-white bg-linear-to-br from-[#060771] via-[#0808a0] to-[#060771] lg:min-h-screen">
          {/* Animated linear overlay */}
          <div className="absolute inset-0 bg-linear-to-tr from-[#ff4136]/20 via-transparent to-[#ff4136]/10 animate-pulse"></div>
          ...
          <div className="relative z-10 text-center space-y-6 max-w-md animate-fade-in">
            ...
            <div className="relative inline-block">
              <div className="w-20 h-20 mx-auto bg-linear-to-br from-white/20 to-white/5 backdrop-blur-md rounded-2xl flex items-center justify-center border border-white/30 shadow-2xl transform hover:scale-110 transition-transform duration-300">
            ...
            <div className="space-y-3">
              ...
              <div className="h-1 w-24 mx-auto bg-linear-to-r from-transparent via-[#ff4136] to-transparent rounded-full"></div>
            </div>
          ...
          {/* Bottom decoration */}
          <div className="absolute bottom-0 left-0 right-0 h-1 bg-linear-to-r from-transparent via-[#ff4136] to-transparent"></div>
        </div>
          ...
          <div className="w-full max-w-lg mx-auto space-y-8 animate-fade-in">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                <div className="h-12 w-1 bg-linear-to-b from-[#ff4136] to-[#060771] rounded-full"></div>
                <div>
                  <h2 className="text-3xl lg:text-4xl font-bold tracking-tight bg-linear-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">
                    Selamat Datang
                  </h2>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2 animate-slide-up animation-delay-200">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    required
                  />
                  <div className="absolute inset-0 -z-10 bg-linear-to-r from-[#ff4136]/0 via-[#ff4136]/5 to-[#060771]/5 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-xl"></div>
                </div>
              </div>
              ...
              <div className="space-y-2 animate-slide-up animation-delay-300">
                ...
                <div className="relative group">
                  ...
                  <div className="absolute inset-0 -z-10 bg-linear-to-r from-[#060771]/0 via-[#060771]/5 to-[#ff4136]/5 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-xl"></div>
                </div>
              </div>
              ...
              <div className="pt-4 animate-slide-up animation-delay-400">
                <button
                  ...
                  disabled={loading}
                  className="group relative w-full py-4 bg-linear-to-r from-[#ff4136] to-[#e63329] text-white font-semibold rounded-xl transition-all duration-300 hover:shadow-2xl hover:shadow-[#ff4136]/30 hover:-translate-y-0.5 disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none overflow-hidden"
                >
                  ...
                  <div className="absolute inset-0 bg-linear-to-r from-[#e63329] to-[#ff4136] opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </button>
              </div>
